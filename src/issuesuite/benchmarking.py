...
class PerformanceBenchmark:
    ...
    def stop_timer(self, name: str, **context: Any) -> float | None:
    ...
    def record_metric(self, name: str, duration_ms: float, **context: Any) -> None:
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        operation_stats: dict[str, dict[str, float | int]] = {}
    ...
    def compare_benchmarks(self, other: PerformanceBenchmark) -> dict[str, Any]:
        ...
        if other_summary.get("total_duration_ms", 0) > 0:
            comparison["performance_ratio"] = self_summary.get(
                "total_duration_ms", 0
...
def get_performance_recommendations(summary: dict[str, Any]) -> list[str]:
    ...
    if slow_ops:
        ...
        if slowest_time > SLOW_OPERATION_MS:  # > 1 second
    ...
    if total_time > TOTAL_TIME_WARNING_MS:  # > 10 seconds
        recommendations.append(
