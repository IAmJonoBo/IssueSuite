...
- [x] Retired the legacy Markdown doc tree now that Starlight holds canonical content, updating repository entry points to reference the workspace directly.【F:docs/README.md†L1-L12】【F:README.md†L52-L87】【F:PACKAGING.md†L66-L74】
...
- [x] Legacy Markdown documentation has been removed so the Starlight workspace remains the single source of truth; rely on `nox -s docs` and the documentation structure tests to guard regressions.【F:docs/README.md†L1-L12】【F:tests/test_documentation_structure.py†L1-L89】
